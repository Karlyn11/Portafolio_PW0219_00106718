...
let submit_bn = document.querySelector("#submit_btn")
...
<td>${schedule}</td>
<td>${datetime.toLocalesString()}</td>
<td>${late}</td>
`
...
submit_btn.addEventListener("Click",()=>{
	...
	let schedule = schedule_dropdown.options[schedule_dropdown.selectIndex].text
